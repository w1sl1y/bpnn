...
//        chart.setExtraLeftOffset(-15);
    ...
    public static void addEntry(LineChart chart,Entry entry){
        LineDataSet lineDataSet;
        if (chart.getData() != null && chart.getData().getDataSetCount() > 0) {
            lineDataSet = (LineDataSet) chart.getData().getDataSetByIndex(0);
            ...
            yValueList.add(new Entry(0,0));
            lineDataSet = new LineDataSet(yValueList, "");
            // 设置曲线颜色
            lineDataSet.setColor(Color.parseColor("#0000FF"));
            // 设置平滑曲线
            lineDataSet.setMode(LineDataSet.Mode.LINEAR);
    ...
    public static void clear(LineChart chart) {
        chart.clear();
        chart.postInvalidate();
    }
}
